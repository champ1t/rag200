...
class ContactHandler:
    ...
    POLITE_PARTICLES = [
        "ครับ", "ค่ะ", "krup", "ka", "หน่อย", "ด้วยครับ", "รบกวน", "ช่วย", 
        "อยากทราบ", "query", "search", "ตอบ", "บอก", "อะไร", "ไหน", 
        "ที่ไหน", "สอบถาม", "ถาม", "คนไหน", "เอ๊ะ", "หล่ะ", 
        "นะ", "จ๊ะ", "จ้า", "สิ", "หน่อยดิ", "ป่าว", "ไหม", "จุง", "เลย", 
        "น้า", "พี่", "ตรงไหน",
