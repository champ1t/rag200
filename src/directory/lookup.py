...
def strip_query(q: str) -> str:
    ...
    for k in [
        "เบอร์โทร", "เบอร์", "โทร", "ติดต่อ", "ขอ", "ของ", "fax", "โทรสาร", "แฟกซ์", 
        "งาน", "ทีม", "กลุ่ม", "ฝ่าย", "สำนักงาน", "สมาชิก", "ช่วย", "บอก", "ตอบ", 
        "คือ", "อะไร", "ตรงไหน", "ที่ไหน", "หน่อย", "ด้วย", "ค๊าฟ", "ครับ",
        "เอ๊ะ", "แล้ว", "หล่ะ", "นะ", "จะ", "หา", "ต้อง", "อยาก", "ได้", "มี", 
        "เอา", "โทรหา", "โทรไป", "คุยกับ", "ทราบ", "ตรงไหน", "ชื่อ", "ว่า",
        "เนี่ย", "น่ะ", "จ้ะ", "จ๋า", "ครับผม", "ค่ะคุณ"
    ]:
        q = q.replace(k, " ")
