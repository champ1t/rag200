...
class TestUXPhase172(unittest.TestCase):
    ...
    def test_nav_page_extraction(self):
        ...
        <html>
        <body>
        <a href="http://10.192.133.33/file1.pdf">Template ZTE</a>
        <a href="http://10.192.133.33/file2.pdf">Get IP</a>
        ...
        import re
        links = re.findall(r'([^>\n|]{2,40})(?:\(|^|\s+)(https?://\S+|ftp://\S+)(?:\)|$|\s)', "Template ZTE (http://10.192.133.33/file1.pdf)")
        ...
        links2 = re.findall(r'([^>\n|]{2,40})(?:\(|^|\s+)(https?://\S+|ftp://\S+)(?:\)|$|\s)', "Get IP (http://10.192.133.33/file2.pdf)")
        if links2:
             t2, u2 = links2[0]
