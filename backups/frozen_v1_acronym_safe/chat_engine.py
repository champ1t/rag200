...
class ChatEngine:
    ...
    def _resolve_pending_followup(self, q: str, latencies: Dict[str, float]) -> Dict[str, Any] | None:
        ...
        if kind not in ["role_choice", "team_choice", "contact_choice"]:
            return None
    ...
    def process(self, q: str, session_id: str = "default") -> Dict[str, Any]:
        ...
        telemetry_data = {
            "timestamp": t_start,
            "query": original_q_str,  # Log original
            "expanded_query": q,      # Log expanded (New field if useful, or just rely on rule)
        ...
        if intent == "CONTACT_LOOKUP":
            ...
            if res.get("route") == "contact_ambiguous":
                 candidates = []
                 try:
