...
class RAGEvaluator:
    ...
    def check_coverage(self, results: List[Any], query: str = "", intent: str = "UNKNOWN") -> Dict[str, Any]:
        ...
        NOTE: Context Recall is architecturally fixed by the frozen Retriever (VectorStore + Chunking).
        Variations in this metric indicate data drift, not model performance.
        """
        if not results:
