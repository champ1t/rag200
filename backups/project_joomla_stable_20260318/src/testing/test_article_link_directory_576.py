...
class TestArticleLinkDirectory576(unittest.TestCase):
    def setUp(self):
        ...
        2. FTTxSM Manual
        FTTxSM User Manual (ftp://10.192.133.33/manual/FTTx/
        UserManual.pdf)
        มาตรฐาน ODN (ftp://10.192.133.33/WorkP4/TOTODNStandard.pdf)
    ...
    def test_directory_priority_and_format(self):
        ...
        self.assertIn("FTTxSM User Manual (ftp://10.192.133.33/manual/FTTx/UserManual.pdf)", ans)
