...
class TestGoldenCases(unittest.TestCase):
    def setUp(self):
        ...
        def mock_find_links(query, threshold=0.65):
            ...
            if "ribbon" in q:
                return [{
                    "items": [{"href": "http://INTERNAL_SMC_IP/smc/index.php?option=com_content&view=article&id=646:ribbon-edgemare6000-doc&catid=49:-smc&Itemid=84", "text": "Ribbon Manual"}],
                    "score": 1.0
                }]
            if "ssh" in q:
                 return [{
                    "items": [{"href": "http://INTERNAL_SMC_IP/smc/index.php?option=com_content&view=article&id=663:ip-ssh&catid=49:-smc&Itemid=84", "text": "SSH Config Guide"}],
                    "score": 1.0
                }]
        ...
        def mock_search(query, top_k=5, **kwargs):
            ...
            if "ssh" in q_lower:
                results.append(MagicMock(
                    ...
                    metadata={"source": "http://INTERNAL_SMC_IP/smc/index.php?option=com_content&view=article&id=663:ip-ssh&catid=49:-smc&Itemid=84", "title": "SSH Config Guide", "score": 1.0}
                ))
            
            # Scenario: Ribbon Fallback (Directory)
            if "ribbon" in q_lower:
                 results.append(MagicMock(
                    page_content="Manual for Ribbon EdgeMare 6000 found Link: http://INTERNAL_SMC_IP/smc/index.php?option=com_content&view=article&id=646:ribbon-edgemare6000-doc&catid=49:-smc&Itemid=84",
                    metadata={"source": "http://INTERNAL_SMC_IP/smc/index.php?option=com_content&view=article&id=646:ribbon-edgemare6000-doc&catid=49:-smc&Itemid=84", "title": "Ribbon Manual", "score": 1.0}
                ))
        ...
        ribbon_url = "http://INTERNAL_SMC_IP/smc/index.php?option=com_content&view=article&id=646:ribbon-edgemare6000-doc&catid=49:-smc&Itemid=84"
        ...
        ssh_url = "http://INTERNAL_SMC_IP/smc/index.php?option=com_content&view=article&id=663:ip-ssh&catid=49:-smc&Itemid=84"
