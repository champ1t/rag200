...
def _is_valid_fact(text: str, seen: set, keywords: List[str] = None, strict_seen: set = None) -> bool:
    ...
    blocklist = ["PVD_FUND_DOMAIN", "nms", "dashboard", "smc ai", "intranet", "web hr"]
...
def is_content_safe(text: str) -> bool:
    ...
    if "http://INTERNAL_SMC_IP/smc/" in text:
        return False
...
def clean_article_html(html: str, base_url: str = "") -> Tuple[str, List[Dict], List[Dict]]:
    ...
    LINK_BLOCKLIST = [
        "PVD_FUND_DOMAIN", "dashboard", "nms", "google.com", "facebook.com", "twitter.com",
